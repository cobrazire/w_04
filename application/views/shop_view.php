 ...
 <div class="rightcol">
  ...
  <table class="shoptable">
    <tr>
      ...
      <td class="shopdesc"><p><span class="boldtext">Pacific Trails Hiking Guide</span></p><br>
        ...
        <form method="post" action="http://ww9.aitsafe.com/cf/add.cfm?userid=B8195250&product=Hiking+Guide&price=19.95">
    ...
    <tr>
      ...
      <td class="shopdesc"><p><span class="boldtext">Yurt Yoga</span></p><br>
      ...
      <form method="post" action="http://ww9.aitsafe.com/cf/add.cfm?userid=B8195250&product=Yurt+Yoga&price=24.95">

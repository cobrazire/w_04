...
<div class="rightcol">
  ...
  <?php echo form_open('home/onsubmitmyreservations'); ?>
  <table class="formtable">
    
    <tr>
      <td id="lefttd"><?php echo form_label('*Email:'); ?></td>
      <td class="righttd"> <?php echo form_input(array('type' => 'email', 'name' => 'email','required'=>'required')); ?></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php echo form_input(array('type' => 'text', 'name' => 'arrival_date','placeholder'=>'mm/dd/yyyy','pattern'=>'^(0[1-9]|1[012])[/](0[1-9]|[12][0-9]|3[01])[/](19|20)\d\d$')); ?>
      </td>
    </tr>
    <tr>
